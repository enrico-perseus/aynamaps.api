...
import * as controller from './flooraccess.controller';
...
router.get('/getByBuildingId/:floor_id', auth.hasRole('admin', 'Customer'), controller.upload, controller.getByBuildingId);
